# Reference: https://github.com/detectRecog/CCPD/blob/master/rpnet/load_data.py
import torch
...
class labelFpsDataLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img = Image.open(img_name)  # .transpose((2, 0, 1))
        ...
        return (
            img,
            torch.as_tensor(bbox_coordinates, dtype=torch.float32),
            lbl,
            img_name,
        )
